...
// Helper: decode an encoded polyline string into List<LatLng>
List<LatLng> decodeEncodedPolylineToLatLng(String encoded) {
  List<LatLng> poly = [];
...
class _HomePageState extends State<HomePage> {
      ...
      if (snap.snapshot.value != null) {
        if ((snap.snapshot.value as Map)["blockStatus"] == "no") {
          ...
          cMethods.displaySnackBar(
            "You are blocked. Contact admin: gouravlambha007@gmail.com",
            context,
          );
        }
      } else {
  ...
  retrieveDirectionDetails() async {
    var pickUpLocation = Provider.of<AppInfoClass>(
      context,
      listen: false,
    ).pickUpLocation;
    var dropOffDestinationLocation = Provider.of<AppInfoClass>(
      context,
      listen: false,
    ).dropOffLocation;
    ...
    List<LatLng> latLngPointsFromPickUpToDestination =
        decodeEncodedPolylineToLatLng(tripDirectionDetailsInfo!.encodedPoints!);
  ...
  makeTripRequest() {
    ...
    Map<String, String> driverCoOrdinates = {"latitude": "", "longitude": ""};
  ...
  updateFromDriverCurrentLocationToDropOffDestination(
    ...
    if (!requestingDirectionDetailsInfo) {
      ...
      var dropOffLocation = Provider.of<AppInfoClass>(
        context,
        listen: false,
      ).dropOffLocation;
  ...
  Widget build(BuildContext context) {
    String? userAddress =
        Provider.of<AppInfoClass>(context, listen: false).pickUpLocation != null
        ? (Provider.of<AppInfoClass>(
                    context,
                    listen: false,
                  ).pickUpLocation!.placeName!.length >
                  35
    ...
    if (tripDirectionDetailsInfo != null) {
      ...
      estimatedTimeCar = tripDirectionDetailsInfo!.durationTextString
          .toString();
    }
    ...
    void calculateFareAndTime() {
      ...
      if (selectedVehicle == "Car") {
        ...
        setState(() {
          ...
          int updatedMinutes = (totalMinutes * 1.2)
              .toInt(); // Increase time by 20%
          estimatedTime = commonMethods.formatTime(
            updatedMinutes,
        ...
        setState(() {
          ...
          int updatedMinutes = (totalMinutes * 0.8)
              .toInt(); // Decrease time by 20%
          estimatedTime = commonMethods.formatTime(
            updatedMinutes,
          ); // Convert back to hours and minutes
        });
        ...
        body: Stack(
          children: [
            ...
            GoogleMap(
              ...
              mapType: MapType.normal, // ✅ keep fixed to avoid undefined error
              ...
              onMapCreated: (GoogleMapController mapController) async {
                ...
                // Complete the controller for web and mobile
