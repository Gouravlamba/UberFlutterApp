...
class _PaymentDialogState extends State<PaymentDialog> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("PAY CASH", style: TextStyle(color: Colors.black)),
            const SizedBox(height: 21),
  ...
  Future<void> makePayment() async {
    try {
      ...
      String amountInPaisa = (double.parse(widget.fareAmount) * 100)
          .toInt()
          .toString();

      // Create payment intent for PKR using the fare amount
      paymentIntent = await _paymentService.createPaymentIntent(
        amountInPaisa,
        'PKR',
      );
